...
import ExamenResultadosScreen from '../screens/informacion/requisitos/ExamenResultadosScreen'
	...
	return (
		<Stack.Navigator>
			...
			<Stack.Screen
				...
				options={{
					header: navigation => <Header title='Felitaciones' />
				}}
			/>
			<Stack.Screen
				name='Performance'
			...
			/>
			<Stack.Screen
				name='ExamenResultados'
				component={ExamenResultadosScreen}
				options={{
					header: ({ navigation }) => <Header title='Resultados del Examen' />
				}}
			/>
		</Stack.Navigator>
	)
