...
const PorRedRetirarScreen = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigation.navigate('PorRedRetirarConfirmado')
    } catch (error) {
    ...
    <Container>
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.instructions}>
          Genere una{' '}
          <Text style={{ fontWeight: 'bold' }}>factura electrónica</Text> con la
          siguiente información y suba el archivo XML:
        </Text>
        ...
        <View style={styles.facturaContainer}>
          ...
          <Text style={styles.facturaData}>
            RAZÓN SOCIAL: JUAN PEÑA OLIVARES LAZO
          </Text>
...
export default PorRedRetirarScreen
